...
from src.all_categories_tab import all_content
from src.core_and_headline_tab import headline_and_core_content
from src.edu_tab import edu_content
from src.energy_tab import energy_content

...
mtm_line_plot, yty_line_plot = _mk_line_plot(mtm_pct_chg_df, yty_pct_chg_df, category="Medical")
...
medical_content = dbc.Container(
    [
        ...
        dcc.Markdown(
            """
            # Percent Change in Medical Care Prices
            """
        ),
        dbc.Tabs(
            [

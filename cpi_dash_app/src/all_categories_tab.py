...
mtm_line_plot, yty_line_plot = _mk_line_plot(mtm_pct_chg_df, yty_pct_chg_df, category="All Categories")
...
all_content = dbc.Container(
    [
        dcc.Store(id="store"),
        html.H1("All CPI Categories"),
        html.Hr(),
        dcc.Markdown(
            """
            # Percent Change in All CPI Categories
            """
        ),
        dbc.Tabs(
            [
